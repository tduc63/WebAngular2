...
var product_guard_service_1 = require("../Service/product-guard.service");
...
ProductModule = __decorate([
    core_1.NgModule({
        imports: [shared_module_1.SharedModule, router_1.RouterModule.forChild([
                { path: 'products/:indpage,:sizepage', component: product_list_component_1.ProductListComponent },
                {
                    path: 'product/:id',
